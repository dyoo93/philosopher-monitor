...
public class Philosopher extends BaseThread {
	...
	public void eat() {
		try {
			...
			System.out.println(this.iTID + " philosopher has started eating.");
			this.yield();
			sleep((long) (Math.random() * TIME_TO_WASTE));
			this.yield();
			System.out.println(this.iTID + " philospher has finished eating");
	...
	public void think() {
		try {
			System.out.println(this.iTID + " philosopher has started thinking");
			this.yield();
			sleep((long) (Math.random() * TIME_TO_WASTE));
			this.yield();
			System.out
					.println(this.iTID + " philosopher has finished thinking");
		} catch (Exception e) {
	 ...
	 */
	public void talk() {
		System.out.println(this.iTID + " philosopher has started talking");
		this.yield();
		saySomething();
		this.yield();
		System.out.println(this.iTID + " philosopher has finished talking");
	}
